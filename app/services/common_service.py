...
from app.lib.custom_exceptions import InvalidDataException, UpdateRecordException
from app.lib.singleton import Singleton
from app.models.base_model import BaseModel
from app.schema_models.base_schema import ListRequest, SearchRequest
...
class CommonService(metaclass=Singleton):
    ...
    @staticmethod
    def search_records(repo: BaseRepo, query_params: Union[SearchRequest, SearchRequestWithIsActive]) -> [BaseModel]:
        model_name = repo.model.__name__
        logger.info(
    ...
    @staticmethod
    def get_all_records(repo: BaseRepo, query_params: Union[ListRequest, ListRequestWithIsActive]) -> [BaseModel]:
        model_name = repo.model.__name__
